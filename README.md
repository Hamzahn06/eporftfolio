...
<head>
    ...
    <title>Hamman Hamza - Portfolio</title>
    ...
    <header>
        <div class="container">
            <nav>
                ...
                <ul class="nav-links">
                    <li><a href="#presentation" data-key="nav.presentation">Presentation</a></li>
                    <li><a href="#skills" data-key="nav.skills">Skills</a></li>
                    <li><a href="#courses" data-key="nav.courses">Academic Courses</a></li>
                    <li><a href="#education" data-key="nav.education">Education</a></li>
                    <li><a href="#engagement" data-key="nav.engagement">Civilian Engagement</a></li>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <h1 data-key="hero.title">Future Computer Engineer</h1>
                <p data-key="hero.subtitle">Passionate about technology and innovation, I'm pursuing my studies in computer science to become a skilled software engineer.</p>
                <div class="hero-btns">
                    <a href="#skills" class="btn" data-key="hero.skillsBtn">View My Skills</a>
                    <a href="#contact" class="btn btn-outline" data-key="hero.contactBtn">Contact Me</a>
                </div>
            </div>
        </div>
    </section>
